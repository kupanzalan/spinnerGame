  ...
  return (
    <section className="w-full max-w-lg flex-start flex-col">
        <h1 className="head_text text-center">
          <span className="orange_gradient">New game</span>
        </h1>
        <p className="desc text-center">
          You can create a user and play with it, if it already exists you will play with the one that has already been created
        </p>
        ...
        <form
          ...
          className="mt-8 w-full flex flex-col gap-3 glassmorphism ustify-center items-center">
            <label>
              <span className="font-satoshi text-2xl text-slate-300">Choose your username:</span>
            </label>
            <input 
